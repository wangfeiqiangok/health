...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "2XLGsCWkaJsDG_pT0zWuZaLwuUZzDNw2A0cwNMfw";
    private static final String SECRETKEY = "yECGMJm5iEf5A3bSnVPdUs_n2Weq1l0XMa_J0q0k";
    private static final String BUCKET = "health";
    public static final String DOMAIN= "pv1jp9l9a.bkt.clouddn.com";
